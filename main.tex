...
\newgeometry{margin=1.7cm, top=1.7cm, bottom=1.9cm}
...
%In addition to this, I have looked for previous work where the geographical distribution of the organization of convection was studied. \cite{mohr1966mesoscale, mohr1999contribution} both show distributions of organized convection, as diagnosed from the \SI{85}{GHz} frequency from satellite observations. \cite{huang2018longterm} also analyses the distribution of MCSs, this time using satellite observations in the infra-red. It will be interesting to compare both of these to the global distributions of shear profiles that I have derived, looking for overlaps and discrepancies in the distributions.
